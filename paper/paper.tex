...
& \bestresult{96.12}{0.56} & \result{92.68}{0.29}
\\
...
TOSCA (ours)
& \bestresult{94.45}{0.65} & \bestresult{91.42}{0.31}
& \bestresult{93.62}{0.59} & \result{90.08}{0.22}
& \bestresult{85.84}{0.36} & \bestresult{81.34}{0.31}
& \bestresult{67.27}{1.79} & \bestresult{59.51}{0.72}
& \bestresult{86.42}{0.93} & \bestresult{80.36}{0.39}
& \result{95.87}{0.43} & \bestresult{92.77}{0.19}
\\
...
RanPAC & $12.24 \pm 0.07$ & $2.64 \pm 0.01$ & $35.62$ & $7.36 \times 10^{6}$ & $4415.97$ & $96.67$ & $2.19$ \\
...
APER-Adapter & $9.28 \pm 0.08$ & $4.91 \pm 0.01$ & $70.74$ & $1.07 \times 10^{7}$ & $4415.97$ & $172.94$ & $87.14$ \\
...
\midrule
\rowcolor{toscarow}
TOSCA (ours) & $51.59 \pm 0.32$ & $3.16 \pm 0.01$ & $35.63$ & $7.34 \times 10^{7}$ & $8178.41$ & $100.23$ & $0.15$ \\
\bottomrule
\end{tabular}%
}
\end{table*}
